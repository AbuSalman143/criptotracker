...
//     const[sortcripto,setSortcripto]=useState("");
...
//     .filter((cripto) =>
//         cripto.name.toLowerCase().includes(input.toLowerCase())
//     )
//     .sort((a, b) => {
//       if (sortcripto === 'market_cap') {
//         return b.market_cap - a.market_cap;
//       } else if (sortcripto === 'percentage_change') {
...
//             <input type="text" placeholder="Search By Name or Symbol " onChange={(e)=>{setInput(e.target.value)}} />
//             <button onClick={() => sortcripto('market_cap')}>Sort By Mkt Cap</button>
//             <button onClick={() => sortcripto('percentage_change')}>Sort by percentage</button>
//         </div>
//         <Tabel cripto={cripto}/>
